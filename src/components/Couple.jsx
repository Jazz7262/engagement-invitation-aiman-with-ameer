                ...
                <div className="row">
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info groom-info">
                            ...
                            <p className="mt-2 mt-lg-3">
                                Professsion: Works at{" "}
                                <strong>Hexaware Technology,</strong> Pune.
                            </p>
                            <p className="mt-2 mt-lg-3">
                                S/O Janab{" "}
                                <strong>Phatan Mohdin Khan Sahab,</strong>
                            </p>
                            <p className="mt-1 mt-lg-2">
                                #10/254, Near Sultanpur Masjid,
                            </p>
                            <p className="mt-1 mt-lg-2">
                                Buddekal Street, Adoni.
                            </p>
                        </div>
                    </div>
                    <div
                    ...
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info bride-info">
                            ...
                            <p className="mt-2 mt-lg-3">
                               Grand D/O Janab{" "}
                                <strong>Panchi Abdul Subhan Sahab(Late).</strong>
                            </p>
                            {/* <p className="mt-1 mt-lg-2">
